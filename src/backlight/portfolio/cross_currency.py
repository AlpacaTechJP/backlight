    ...
    for position in pt.positions:
        ...
        if ccy == base_ccy:
            ...
            try:
                ...
                print("The currency "+ccy+" can't be convert to "+base_ccy+" because data is not on the market.")
            else:
                ...
                new_p = pd.DataFrame(pos_values * ratios_values, columns=position.columns, index=idx)
